...
################################################################################
## Form generated from reading UI file 'create_projectxKXnBz.ui'
##
...
class Ui_create_project(object):
    def setupUi(self, create_project):
        ...
        create_project.setMinimumSize(QSize(360, 340))
...
"}")
        ...
        self.gridLayout.addWidget(self.incorrect_data, 8, 0, 1, 3)
        ...
        self.de_deadline.setDateTime(QDateTime(QDate(2026, 3, 1), QTime(8, 0, 0)))
        ...
        self.gridLayout.addWidget(self.enable_Stages, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.add_Stage, 7, 0, 1, 2)
