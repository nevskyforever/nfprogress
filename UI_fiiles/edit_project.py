...
class Ui_edit_project(object):
    def setupUi(self, edit_project):
        if not edit_project.objectName():
            edit_project.setObjectName(u"edit_project")
        edit_project.resize(349, 311)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(3)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(edit_project.sizePolicy().hasHeightForWidth())
        edit_project.setSizePolicy(sizePolicy)
        edit_project.setMinimumSize(QSize(349, 311))
        edit_project.setMaximumSize(QSize(349, 311))
        font = QFont()
        font.setFamilies([u"Arial"])
        edit_project.setFont(font)
        self.buttons = QDialogButtonBox(edit_project)
        ...
        self.widget = QWidget(edit_project)
...
"}")
        ...
        self.retranslateUi(edit_project)
        self.buttons.accepted.connect(edit_project.accept)
        self.buttons.rejected.connect(edit_project.reject)

        QMetaObject.connectSlotsByName(edit_project)
    # setupUi

    def retranslateUi(self, edit_project):
        edit_project.setWindowTitle(QCoreApplication.translate("edit_project", u"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0435 \u043f\u0440\u043e\u0435\u043a\u0442\u0430", None))
        self.label_6.setText(QCoreApplication.translate("edit_project", u"\u0441\u0438\u043c\u0432\u043e\u043b\u043e\u0432 (\u0447\u0438\u0441\u043b\u043e)", None))
        self.label_3.setText(QCoreApplication.translate("edit_project", u"\u0414\u0435\u0434\u043b\u0430\u0439\u043d", None))
        self.checkBox.setText(QCoreApplication.translate("edit_project", u"\u041d\u0435\u0442", None))
        self.label_2.setText(QCoreApplication.translate("edit_project", u"\u0426\u0435\u043b\u044c", None))
        self.label.setText(QCoreApplication.translate("edit_project", u"\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435", None))
        self.incorrect_name.setText(QCoreApplication.translate("edit_project", u"<html><head/><body><p align=\"center\">\u0418\u043c\u044f \u0443\u0436\u0435<br/>\u0438\u0441\u043f\u043e\u043b\u044c\u0437\u0443\u0435\u0442\u0441\u044f</p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("edit_project", u"<html><head/><body><p>\u0422\u0435\u043a\u0443\u0449\u0435\u0435<br/>\u043a\u043e\u043b-\u0432\u043e</p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("edit_project", u"\u0441\u0438\u043c\u0432\u043e\u043b\u043e\u0432 (\u0447\u0438\u0441\u043b\u043e)", None))
        self.le_name.setText(QCoreApplication.translate("edit_project", u"\u041d\u043e\u0432\u044b\u0439 \u043f\u0440\u043e\u0435\u043a\u0442", None))
        self.le_total_symbols.setText(QCoreApplication.translate("edit_project", u"0", None))
        self.incorrect_data.setText(QCoreApplication.translate("edit_project", u"<html><head/><body><p align=\"center\">\u041d\u0435\u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u0435 \u0434\u0430\u043d\u043d\u044b\u0435</p></body></html>", None))
    # retranslateUi
