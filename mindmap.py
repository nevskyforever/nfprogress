        ...
        return json.dumps(
            {
                ...
                'addChildLabel': tr('Добавить дочерний элемент'),
                'addSiblingLabel': tr('Добавить на этом уровне'),
                'addNearbyNoteLabel': tr('Добавить заметку рядом'),
                'editLabel': tr('Изменить'),
                'linkLabel': tr('Связать'),
                'linkFloatingLabel': tr('Связать со свободным элементом'),
                'removeLabel': tr('Удалить'),
