...
class Ui_Bamk(object):
    def setupUi(self, Bamk):
        ...
        self.gridLayout.addWidget(self.credit_status, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.deposit_status, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Bamk):
        Bamk.setWindowTitle(QCoreApplication.translate("Bamk", u"Dialog", None))
