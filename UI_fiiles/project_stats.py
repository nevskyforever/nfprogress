...
class Ui_project_stats(object):
    def setupUi(self, project_stats):
        if not project_stats.objectName():
            project_stats.setObjectName(u"project_stats")
        project_stats.resize(396, 405)
        font = QFont()
        ...
        self.stat_best_day.setWordWrap(True)
        ...
        self.stat_current_streak.setWordWrap(True)
        ...
        self.stat_avg_symbols_per_active_day.setWordWrap(True)
        ...
        self.stat_total_in_unit.setWordWrap(True)
        ...
        self.stat_max_streak.setWordWrap(True)
        ...
        self.stat_days_since_start.setWordWrap(True)
        ...
        self.stat_active_days_count.setWordWrap(True)
        ...
        self.stat_active_days_percent.setWordWrap(True)
        ...
        self.retranslateUi(project_stats)

        QMetaObject.connectSlotsByName(project_stats)
    # setupUi
    ...
    def retranslateUi(self, project_stats):
        ...
        self.label_13.setText(QCoreApplication.translate("project_stats", u"\u0412\u0441\u0435\u0433\u043e \u043d\u0430\u043f\u0438\u0441\u0430\u043d\u043e \u0432 \u0435\u0434\u0438\u043d\u0438\u0446\u0435 \u043f\u0440\u043e\u0435\u043a\u0442\u0430:", None))
        self.stat_avg_symbols_per_note.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.label_20.setText(QCoreApplication.translate("project_stats", u"\u0414\u043d\u0435\u0439 \u0441 \u043d\u0430\u0447\u0430\u043b\u0430 \u043f\u0440\u043e\u0435\u043a\u0442\u0430:", None))
        self.stat_avg_symbols_per_active_day.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.stat_freezes_used.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.label.setText(QCoreApplication.translate("project_stats", u"\u041a\u043e\u043b-\u0432\u043e \u0437\u0430\u043f\u0438\u0441\u0435\u0439:", None))
        self.stat_notes_count.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.label_9.setText(QCoreApplication.translate("project_stats", u"\u041b\u0443\u0447\u0448\u0438\u0439 \u0434\u0435\u043d\u044c (\u043c\u0430\u043a\u0441\u0438\u043c\u0443\u043c \u0441\u0438\u043c\u0432\u043e\u043b\u043e\u0432 \u0437\u0430 \u043e\u0434\u043d\u0443 \u0434\u0430\u0442\u0443):", None))
        self.label_15.setText(QCoreApplication.translate("project_stats", u"\u0421\u0440\u0435\u0434\u043d\u0435\u0435 \u0441\u0438\u043c\u0432\u043e\u043b\u043e\u0432 \u0432 \u0434\u0435\u043d\u044c:", None))
        self.label_21.setText(QCoreApplication.translate("project_stats", u"\u0410\u043a\u0442\u0438\u0432\u043d\u044b\u0445 \u0434\u043d\u0435\u0439 (\u0434\u043d\u0435\u0439, \u043a\u043e\u0433\u0434\u0430 \u0431\u044b\u043b\u0430 \u0445\u043e\u0442\u044c \u043e\u0434\u043d\u0430 \u0437\u0430\u043f\u0438\u0441\u044c):", None))
        self.stat_total_in_unit.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.label_19.setText(QCoreApplication.translate("project_stats", u"\u041c\u0430\u043a\u0441\u0438\u043c\u0430\u043b\u044c\u043d\u044b\u0439 \u0441\u0442\u0440\u0438\u043a:", None))
        self.label_17.setText(QCoreApplication.translate("project_stats", u"\u0422\u0435\u043a\u0443\u0449\u0438\u0439 \u0441\u0442\u0440\u0438\u043a (\u0434\u043d\u0435\u0439):", None))
        self.label_7.setText(QCoreApplication.translate("project_stats", u"\u0418\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u043e \u0437\u0430\u043c\u043e\u0440\u043e\u0437\u043e\u043a:", None))
        self.stat_best_weekday.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.label_11.setText(QCoreApplication.translate("project_stats", u"\u0421\u0430\u043c\u044b\u0439 \u043f\u0440\u043e\u0434\u0443\u043a\u0442\u0438\u0432\u043d\u044b\u0439 \u0434\u0435\u043d\u044c \u043d\u0435\u0434\u0435\u043b\u0438:", None))
        self.stat_avg_notes_per_day.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.label_5.setText(QCoreApplication.translate("project_stats", u"\u0421\u0440\u0435\u0434\u043d\u0435\u0435 \u043a\u043e\u043b-\u0432\u043e \u0437\u0430\u043f\u0438\u0441\u0435\u0439 \u0432 \u0434\u0435\u043d\u044c:", None))
        self.label_22.setText(QCoreApplication.translate("project_stats", u"\u041f\u0440\u043e\u0446\u0435\u043d\u0442 \u0430\u043a\u0442\u0438\u0432\u043d\u044b\u0445 \u0434\u043d\u0435\u0439 \u043e\u0442 \u043e\u0431\u0449\u0435\u0433\u043e \u0432\u0440\u0435\u043c\u0435\u043d\u0438 \u043f\u0440\u043e\u0435\u043a\u0442\u0430:", None))
        self.stat_max_streak.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.stat_days_since_start.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.stat_active_days_count.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
        self.stat_active_days_percent.setText(QCoreApplication.translate("project_stats", u"\u041d\u0435\u0442 \u0434\u0430\u043d\u043d\u044b\u0445", None))
    # retranslateUi
