...
| Statistics frontend | [in progress] | `frontend/src/core/statistics` owns parity-tested pure calculations and the adapter supplies them to the existing UI; Python `/statistics` remains the reference/source for freezes and streak state |
