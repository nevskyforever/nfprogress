...
class Ui_create_project(object):
    def setupUi(self, create_project):
        ...
        self.gridLayout.addWidget(self.add_Stage, 9, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.enable_Stages, 8, 0, 1, 2)
...
"}")
        ...
        self.gridLayout.addWidget(self.incorrect_data, 10, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.le_total_symbols, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.cb_unit, 6, 1, 1, 2)
