...
################################################################################
## Form generated from reading UI file 'bankpvUxdS.ui'
##
...
class Ui_Bamk(object):
    def setupUi(self, Bamk):
        ...
        self.gridLayout.addWidget(self.deposit_status, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.make_a_loan_payment, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.return_credit_btn, 6, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.partial_loan_repayment, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.make_deposit_btn, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.return_deposit_btn, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.withdraw_interest_from_a_deposit, 4, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.take_credit_btn, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.return_credit_date, 3, 2, 1, 1)

        self.return_deposit_date = QLabel(Bamk)
        self.return_deposit_date.setObjectName(u"return_deposit_date")

        self.gridLayout.addWidget(self.return_deposit_date, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.deposit_total_sum, 2, 1, 1, 1)

        self.label_2 = QLabel(Bamk)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setWordWrap(True)

        self.gridLayout.addWidget(self.label_2, 4, 1, 1, 1)

        self.label = QLabel(Bamk)
        self.label.setObjectName(u"label")
        self.label.setWordWrap(True)

        self.gridLayout.addWidget(self.label, 4, 2, 1, 1)

        self.credit_score = QLabel(Bamk)
        self.credit_score.setObjectName(u"credit_score")

        self.gridLayout.addWidget(self.credit_score, 4, 0, 1, 1)
    ...
    def retranslateUi(self, Bamk):
        ...
        self.active_deposit_topup_amount.setPlaceholderText(QCoreApplication.translate("Bamk", u"\u0421\u0443\u043c\u043c\u0430 \u043a \u043f\u043e\u043f\u043b\u043d\u0435\u043d\u0438\u044e (100.0)", None))
