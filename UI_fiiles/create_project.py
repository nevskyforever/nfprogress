...
################################################################################
## Form generated from reading UI file 'create_projectoxazPV.ui'
##
...
"}")
        ...
        self.gridLayout.addWidget(self.incorrect_data, 7, 0, 1, 3)
...
"}")
        ...
        self.gridLayout.addWidget(self.de_deadline, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.le_goal, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.cb_unit, 1, 1, 1, 1)
