...
################################################################################
## Form generated from reading UI file 'bankYjdoPt.ui'
##
...
class Ui_Bamk(object):
    def setupUi(self, Bamk):
        ...
        self.gridLayout_2.addWidget(self.withdraw_interest_from_a_deposit, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.return_credit_btn, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.partial_loan_repayment, 3, 0, 1, 1)
