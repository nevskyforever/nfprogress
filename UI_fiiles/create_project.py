...
class Ui_create_project(object):
    def setupUi(self, create_project):
        ...
        self.add_Stage = QPushButton(self.widget)
        self.add_Stage.setObjectName(u"add_Stage")
        ...
        self.gridLayout.addWidget(self.le_personal_goal_for_the_day, 4, 1, 1, 1)
        ...
        self.recalculate_plan_checkBox = QCheckBox(self.widget)
        self.recalculate_plan_checkBox.setObjectName(u"recalculate_plan_checkBox")

        self.gridLayout.addWidget(self.recalculate_plan_checkBox, 5, 0, 1, 3)

        self.enable_Stages = QCheckBox(self.widget)
        self.enable_Stages.setObjectName(u"enable_Stages")
...
"}")
        ...
        self.gridLayout.addWidget(self.le_total_symbols, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.cb_unit, 7, 1, 1, 2)
        ...
        self.streak_checkBox = QCheckBox(self.widget)
        self.streak_checkBox.setObjectName(u"streak_checkBox")
        ...
        QWidget.setTabOrder(self.le_name, self.le_goal)
        QWidget.setTabOrder(self.le_goal, self.de_deadline)
        QWidget.setTabOrder(self.de_deadline, self.checkBox)
        QWidget.setTabOrder(self.checkBox, self.le_personal_goal_for_the_day)
        QWidget.setTabOrder(self.le_personal_goal_for_the_day, self.le_total_symbols)
        QWidget.setTabOrder(self.le_total_symbols, self.cb_unit)
        QWidget.setTabOrder(self.cb_unit, self.recalculate_plan_checkBox)
        QWidget.setTabOrder(self.recalculate_plan_checkBox, self.enable_Stages)
        QWidget.setTabOrder(self.enable_Stages, self.add_Stage)
        QWidget.setTabOrder(self.add_Stage, self.combine_stage_mindmaps_checkBox)
        QWidget.setTabOrder(self.combine_stage_mindmaps_checkBox, self.streak_checkBox)
        QWidget.setTabOrder(self.streak_checkBox, self.auto_freeze_checkBox)
    ...
    def retranslateUi(self, create_project):
        ...
        create_project.setAccessibleName(QCoreApplication.translate("create_project", u"\u0421\u043e\u0437\u0434\u0430\u043d\u0438\u0435 \u043f\u0440\u043e\u0435\u043a\u0442\u0430", None))
...
#if QT_CONFIG(accessibility)
        self.le_name.setAccessibleName(QCoreApplication.translate("create_project", u"\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435", None))
#endif // QT_CONFIG(accessibility)
        self.le_name.setText(QCoreApplication.translate("create_project", u"\u041d\u043e\u0432\u044b\u0439 \u043f\u0440\u043e\u0435\u043a\u0442", None))
        self.add_Stage.setText(QCoreApplication.translate("create_project", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u042d\u0442\u0430\u043f", None))
...
#if QT_CONFIG(accessibility)
        self.le_personal_goal_for_the_day.setAccessibleName(QCoreApplication.translate("create_project", u"\u041b\u0438\u0447\u043d\u0430\u044f \u0446\u0435\u043b\u044c \u043d\u0430 \u0434\u0435\u043d\u044c", None))
#endif // QT_CONFIG(accessibility)
        self.le_personal_goal_for_the_day.setText(QCoreApplication.translate("create_project", u"0", None))
#if QT_CONFIG(accessibility)
        self.le_goal.setAccessibleName(QCoreApplication.translate("create_project", u"\u0426\u0435\u043b\u044c", None))
#endif // QT_CONFIG(accessibility)
...
#if QT_CONFIG(accessibility)
        self.le_total_symbols.setAccessibleName(QCoreApplication.translate("create_project", u"\u0412\u0441\u0435\u0433\u043e \u043d\u0430\u043f\u0438\u0441\u0430\u043d\u043e", None))
#endif // QT_CONFIG(accessibility)
...
#if QT_CONFIG(accessibility)
        self.cb_unit.setAccessibleName(QCoreApplication.translate("create_project", u"\u0415\u0434\u0438\u043d\u0438\u0446\u0430 \u0438\u0437\u043c\u0435\u0440\u0435\u043d\u0438\u044f", None))
#endif // QT_CONFIG(accessibility)
        self.label_5.setText(QCoreApplication.translate("create_project", u"\u0435\u0434\u0438\u043d\u0438\u0446 (\u0447\u0438\u0441\u043b\u043e)", None))
#if QT_CONFIG(accessibility)
        self.de_deadline.setAccessibleName(QCoreApplication.translate("create_project", u"\u0414\u0435\u0434\u043b\u0430\u0439\u043d", None))
#endif // QT_CONFIG(accessibility)
