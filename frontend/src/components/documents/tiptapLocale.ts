...
export function tiptapLocale(t: (source: string) => string): Record<string, unknown> {
  ...
  const editor = {
    heading: t('Заголовок'), heading1: t('Заголовок 1'), heading2: t('Заголовок 2'), heading3: t('Заголовок 3'),
    heading4: t('Заголовок 4'), heading5: t('Заголовок 5'), heading6: t('Заголовок 6'), paragraph: t('Обычный текст'),
